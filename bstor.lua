...
local function drawPlayers()
  for i=1, #players do
    ...
    if ox < 6 and ox > -6 and oz < 6 and oz > -6 then
      if oy == 0 or oy == -1 then
        term.setCursorPos(ox + 7,oz + 7)
        term.blit(string.sub(name,1,1),"4","7")
      end
    end
  end
  sleep(0.1)
  ...
  while true do
    ...
    for ox=-5, 5 do
      for oz=-5, 5 do
        ...
        if gotblock then
          if gotblock == "computer" or gotblock == "computer_advanced" or gotblock == "turtle" or gotblock == "turtle_advanced" then
            term.write("\21")
          elseif gotblock == "chest" or gotblock == "barrel" or gotblock == "disk_drive" then
            term.write("\169")
          elseif gotblock == "water" or gotblock == "lava" then
            term.write("\126")
          else
