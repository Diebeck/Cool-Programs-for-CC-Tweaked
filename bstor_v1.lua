...
local yview = 0
local selectedBlock = "\171 Click to see block"
local slotn = 0
local slotAmount = 1
...
local function checkClicks()
  while true do
    ...
    elseif x > 1 and x < 13 and y > 1 and y < 13 then
      selectedBlock = getBlock(turtledata.x + x - 7, turtledata.y + yview, turtledata.z + y -7)
      if selectedBlock == nil then selectedBlock = "air" end
...
term.blit("\31 \30 e","77777","0f0f0")

parallel.waitForAll(save, drawData, drawBlocks, checkClicks, checkKeys, debug)